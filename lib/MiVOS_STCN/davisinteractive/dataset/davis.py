...
class Davis:
    ...
    def __init__(self, davis_root=None, single_object=False, eval_each_object=False):
        ...
        if self.single_object or not self.eval_each_object:
            for sequence_name, sequence_data in self.dataset.items():
                sequence_data['num_objects'] = 1
